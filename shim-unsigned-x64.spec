...
Version:	15.6
Release:	1%{?dist}%{?mlrelease}
Summary:	First-stage UEFI bootloader
ExclusiveArch:	x86_64
License:	BSD
URL:		https://github.com/rhboot/shim
Source0:	https://github.com/rhboot/shim/releases/download/%{version}/shim-%{version}.tar.bz2
Source1:	mlsecureboot004.der
...
%changelog
* Thu Jul 21 2022 Yuki Hoshino <yuki.hoshino@miraclelinux.com> - 15.6-1.el8.ML.1
- Replace the der file and the sbat file for MIRACLE LINUX release
