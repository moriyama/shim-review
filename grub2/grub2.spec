...
%define __pesign_client_token "MIRACLE LINUX Secure Boot (ke..."
%define __pesign_client_cert "Certificate for PIV Authentication"

Name:		grub2
Epoch:		1
Version:	2.02
Release:	123%{?dist}.8%{?mlrelease}
...
Source15:	ml_ca_secureboot_v4_2022.der
Source16:	mlsecureboot004.der
...
%changelog 
* Fri Jul 22 2022 Yuki Hoshino <yuki.hoshino@miraclelinux.com> - 2.06-123.el8.8.ML.1
- Disable multiple certificates
- Relpace the certificate and singing for ours.
