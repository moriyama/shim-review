...
%define __pesign_client_token "MIRACLE LINUX 9 Secure Boot (..."
%define __pesign_client_cert "Certificate for PIV Authentication"
...
%define pesign_name_0 ml9secureboot001
...
#Sources for MIRACLE LINUX debranding
Source100: miraclelinux9_v1.pem
...
# Patches for MIRACLE LINUX debranding
Patch1000: trademark-removal.patch
...
Summary: The MIRACLE LINUX kernel ABI symbol stablelists
AutoReqProv: no
%description -n kernel-abi-stablelists
The kABI package contains information pertaining to the MIRACLE LINUX
...
The package contains data describing the current ABI of the MIRACLE LINUX
...
This package provides kernel modules for the %{?2:%{2} }kernel package for MIRACLE LINUX internal usage.\
%{nil}
...
# Add DUP certificates to system trusted keys for MIRACLE LINUX
%if 0%{?rhel}
%if %{signkernel}%{signmodules}
cat %{SOURCE100} > ../certs/rhel.pem
%if %{signkernel}
...
%endif
    ...
    # MIRACLE LINUX UEFI Secure Boot CA cert, which can be used to authenticate the kernel
...
#
%changelog
* Fri Jun 10 2022 Yasuhiro Nakamura <yasuhiro.nakamura@miraclelinux.com> [5.14.0-70.13.1.el9_0]
- Add secureboot certs for MIRACLE LINUX.
- Debranding for MIRACLE LINUX.
- Add MIRACLE LINUX cert file.
